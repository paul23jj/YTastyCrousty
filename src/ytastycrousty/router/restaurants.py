...
from ..security import recuperer_utilisateur, verifier_admin
...
@router.patch("/{restaurant_id}", response_model=RestaurantOut, dependencies=[Depends(verifier_admin)])
...
@router.patch("/{restaurant_id}/availability", response_model=RestaurantOut, dependencies=[Depends(verifier_admin)])
